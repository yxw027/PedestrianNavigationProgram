function plot_rtk2(result,est_prm)
%-------------------------------------------------------------------------------
...
% box on
% 
% xlim([min(result1.pos(:,1)),max(result1.pos(:,1))]);															% X軸の範囲
% set(gca,'XTick',[min(result1.pos(:,1)):1000:max(result1.pos(:,1))]);											% X軸の目盛り
% ylim([min(result1.pos(:,2)),max(result1.pos(:,2))]);															% Y軸の範囲
% set(gca,'YTick',[min(result1.pos(:,2)):1000:max(result1.pos(:,2))]);											% Y軸の目盛り
% zlim([min(result1.pos(:,3)),max(result1.pos(:,3))]);															% Z軸の範囲
% set(gca,'ZTick',[min(result1.pos(:,3)):1000:max(result1.pos(:,3))]);											% Z軸の目盛り
% 
% 
% LLH
%--------------------------------------------
...
xlim([min(result1.pos(:,7)),max(result1.pos(:,7))]);															% X軸の範囲
set(gca,'XTick',[min(result1.pos(:,7)):1000:max(result1.pos(:,7))]);											% X軸の目盛り
ylim([min(result1.pos(:,8)),max(result1.pos(:,8))]);															% Y軸の範囲
set(gca,'YTick',[min(result1.pos(:,8)):1000:max(result1.pos(:,8))]);											% Y軸の目盛り
zlim([min(result1.pos(:,9)),max(result1.pos(:,9))]);															% Z軸の範囲
set(gca,'ZTick',[min(result1.pos(:,9)):1000:max(result1.pos(:,9))]);											% Z軸の目盛り
