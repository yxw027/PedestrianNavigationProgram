...
est_prm.stime  = '2019/07/04/04/46/45';					% Start time (例: '2007/01/01/00/00/00')
est_prm.etime  = '2019/07/04//05/45';					% End time   (例: '2007/01/01/24/00/00')

% データファイル設定
%--------------------------------------------
% ファイルは指定(上記の局番号は必ず設定すること, DLする場合は '' , [] にすること)
est_prm.file.rov_o = 'Nexus_3_20.19o';			% Rov obs             (例: '****.07o')
est_prm.file.rov_n = '0111.19n';			% Rov nav(GPS)        (例: '****.07n')
est_prm.file.csv = 'Nexus_3_20.csv';
