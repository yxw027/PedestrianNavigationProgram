...
est_prm.stime  = '2019/01/22/07/10/01';					% Start time (例: '2007/01/01/00/00/00')
est_prm.etime  = '2019/01/22/07/10/16';					% End time   (例: '2007/01/01/24/00/00')

% データファイル設定
%--------------------------------------------
% ファイルは指定(上記の局番号は必ず設定すること, DLする場合は '' , [] にすること)
est_prm.file.rov_o = '2.19o';			% Rov obs             (例: '****.07o')
est_prm.file.rov_n = '0122.19n';			% Rov nav(GPS)        (例: '****.07n')
est_prm.file.csv = '2.csv';
...
% 歩幅の初期値
est_prm.steplength = 0.607596812215361;
