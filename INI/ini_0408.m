...
est_prm.stime  = '2018/4/19/08/37/30';					% Start time (例: '2007/01/01/00/00/00')
est_prm.etime  = '2018/4/19/08/44/22';					% End time   (例: '2007/01/01/24/00/00')

% データファイル設定
%--------------------------------------------
% ファイルは指定(上記の局番号は必ず設定すること, DLする場合は '' , [] にすること)
est_prm.file.rov_o = '2018_4_19_8_37.18o';			% Rov obs             (例: '****.07o')
est_prm.file.rov_n = 'brdc1090 (3).18n';			% Rov nav(GPS)        (例: '****.07n')
est_prm.file.csv = '2018_4_19_8_37.csv';
