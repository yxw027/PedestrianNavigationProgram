...
est_prm.stime  = '2017/12/19/06/24/44';					% Start time (例: '2007/01/01/00/00/00')
est_prm.etime  = '2017/12/19/06/26/01';					% End time   (例: '2007/01/01/24/00/00')

% データファイル設定
%--------------------------------------------
% ファイルは指定(上記の局番号は必ず設定すること, DLする場合は '' , [] にすること)
est_prm.file.rov_o = '2017_12_19_6_24.17o';			% Rov obs             (例: '****.07o')
est_prm.file.rov_n = '2017_12_19_6_24.17n';			% Rov nav(GPS)        (例: '****.07n')
est_prm.file.csv = '2017_12_19_6_24.csv';
