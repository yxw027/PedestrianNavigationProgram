...
est_prm.stime  = '2019/01/22/07/06/43';					% Start time (例: '2007/01/01/00/00/00')
est_prm.etime  = '2019/01/22/07/07/57';					% End time   (例: '2007/01/01/24/00/00')

% データファイル設定
%--------------------------------------------
% ファイルは指定(上記の局番号は必ず設定すること, DLする場合は '' , [] にすること)
est_prm.file.rov_o = '1.19o';			% Rov obs             (例: '****.07o')
est_prm.file.rov_n = '0122.19n';			% Rov nav(GPS)        (例: '****.07n')
est_prm.file.csv = '1.csv';
...
est_prm.statemodel.std_walking = 0.02^2;               %%歩幅
...
est_prm.P0.std_walking = 0.01^2;                     % 歩幅[E方向, N方向]
