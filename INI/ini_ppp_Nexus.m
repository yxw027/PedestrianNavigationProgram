...
est_prm.stime  = '2019/01/11/09/04/14';					% Start time (例: '2007/01/01/00/00/00')
est_prm.etime  = '2019/01/11/09/03/15';					% End time   (例: '2007/01/01/24/00/00')

% データファイル設定
%--------------------------------------------
% ファイルは指定(上記の局番号は必ず設定すること, DLする場合は '' , [] にすること)
est_prm.file.rov_o = 'Nexus_3.19o';			% Rov obs             (例: '****.07o')
est_prm.file.rov_n = '0111.19n';			% Rov nav(GPS)        (例: '****.07n')
est_prm.file.csv = 'Nexus_3.csv';
