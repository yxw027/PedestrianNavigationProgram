...
est_prm.stime  = '2018/6/27/08/39/12';					% Start time (例: '2007/01/01/00/00/00')
est_prm.etime  = '2018/6/27/08/40/27';					% End time   (例: '2007/01/01/24/00/00')

% データファイル設定
%--------------------------------------------
% ファイルは指定(上記の局番号は必ず設定すること, DLする場合は '' , [] にすること)
est_prm.file.rov_o = '2018_6_27_8_39.18o';			% Rov obs             (例: '****.07o')
est_prm.file.rov_n = 'brdc1780.18n';			% Rov nav(GPS)        (例: '****.07n')
est_prm.file.csv = '2018_6_27_8_39.csv';
